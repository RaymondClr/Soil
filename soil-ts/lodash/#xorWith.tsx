 ...
 * // => [{ 'x': 2, 'y': 1 }, { 'x': 1, 'y': 1 }]
 */
function xorWith<T extends Array<any>>(...arrays: Array<T | ((target: any, value: any) => any)>): Array<T> {
    const values = arguments as unknown as Array<T | ((value: any) => any)>;
    let comparator = last(values);
    comparator = typeof comparator === "function" ? comparator : undefined;
    return baseXor(
        filter(values as Array<Array<T>>, (value): value is Array<T> => isArrayLikeObject(value)),
        undefined,
        comparator
    );
}
