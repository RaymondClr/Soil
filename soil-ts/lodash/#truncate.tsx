 ...
 */
function truncate(string: string, { length = 30, omission = "...", separator }: { length?: number; omission?: string; separator?: string | RegExp }): string {
    let strSymbols: Array<string> = [];
    ...
    let result = strSymbols.length > 0 ? castSlice(strSymbols, 0, end).join("") : string.slice(0, end);
    ...
    if (isRegExp(separator)) {
        if (string.slice(end).search(separator)) {
            ...
            if (!separator.global) {
                separator = RegExp(separator.source, `${reFlags.exec(separator.toString()) || ""}g`);
            }
...
// import baseToString from "./_internal/baseToString.js";
// import castSlice from "./_internal/castSlice.js";
// import hasUnicode from "./_internal/hasUnicode.js";
// import isObject from "./isObject.js";
// import isRegExp from "./isRegExp.js";
// import stringSize from "./_internal/stringSize.js";
