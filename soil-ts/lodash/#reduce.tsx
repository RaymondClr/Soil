 ...
 */
function reduce<T>(array: Array<T>, iteratee: Reducer<T, T>): T | undefined;
function reduce<T, TResult>(array: Array<T>, iteratee: Reducer<T, TResult>, initialValue: TResult): TResult;
