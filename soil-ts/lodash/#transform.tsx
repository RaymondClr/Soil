 ...
 * @since 1.3.0
 * @category Object
 * @param {Object} array The object to iterate over.
 ...
 * // => { '1': ['a', 'c'], '2': ['b'] }
 */
function transform<T, S>(array: Array<T>, iteratee: (accumulator: Array<S>, value: T, index: number, object: Array<T>) => boolean, accumulator: Array<S> = []): Array<S> {
...
// import baseForOwn from "./_internal/baseForOwn.js";
