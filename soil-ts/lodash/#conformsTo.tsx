 ...
 * // => false
 */
function conformsTo<T extends object>(object: T, source: { [P in keyof T]: (value: T[keyof T]) => boolean }): boolean {
    return source == null || baseConformsTo(object, source, keys(source));
}

export default conformsTo;
// import baseConformsTo from "./_internal/baseConformsTo.js";
