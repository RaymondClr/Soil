 ...
 * // => [4, 5, 2, 3, 0, 1]
 */
function reduceRight<T>(array: Array<T>, iteratee: Reducer<T, T>): T | undefined;
function reduceRight<T, TResult>(array: Array<T>, iteratee: Reducer<T, TResult>, initialValue: TResult): TResult;
