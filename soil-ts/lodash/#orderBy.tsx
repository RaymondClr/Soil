 ...
 *
 */
function orderBy<T>(array: Array<any>, iteratees: Array<(value: T) => any>, orders: Array<string | AnyFunction>): Array<any> {
    if (array == null) {
        return [];
    }
...
// import baseOrderBy from "./_internal/baseOrderBy.js";
