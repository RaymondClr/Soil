 ...
 * @since 0.1.0
 * @category Soil
 * @see {@linkcode getFirstSelectedProperty}
 * @example
 *
 * ```ts
 ...
 * ```
 */
let getSelectedProperties: () => _PropertyClasses[] | undefined = createGetAppProperty<_PropertyClasses[] | undefined>(["project", "activeItem", "selectedProperties"]);
