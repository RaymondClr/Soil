 ...
 *     if (_.isProperty(property) && _.isColorProperty(property)) {
 ...
 * ```
 */
function getProperty<TResult extends Property | PropertyGroup>(rootProperty: Property | PropertyGroup, path: Array<PropertyName>): TResult | null {
    let index = 0;
    ...
    return index && index === length ? (nested as TResult) : null;
}
