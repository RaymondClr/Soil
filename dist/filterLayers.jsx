// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/21 12:03:37
...
(function() {
    ...
    if (isCompItem(activeComp)) {
        var shapeLayers = filterLayers(activeComp, isShapeLayer);
        log(map(shapeLayers, function(layer) {
            return layer.name;
        }));
    }
}).call(this);
