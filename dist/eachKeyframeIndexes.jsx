// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/19 18:38:29
...
(function() {
    ...
    if (selectedProperty) {
        if (hasKeyframes(selectedProperty)) {
            eachKeyframeIndexes(selectedProperty, function(property, keyIndex) {
                log(property.keyTime);
            });
        }
    }
}).call(this);
