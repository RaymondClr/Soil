// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/18 14:43:18
...
(function() {
    ...
    if (isRasterLayer(selectedLayer)) {
        addProperty(selectedLayer, [ "ADBE Effect Parade", "ADBE Checkbox Control" ]);
    }
    if (isRasterLayer(selectedLayer)) {
        addProperty(selectedLayer, [ "effect", "颜色控制" ]);
    }
    var shapeLayer = getFirstSelectedLayer();
    if (isShapeLayer(shapeLayer)) {
        addProperty(shapeLayer, [ "ADBE Root Vectors Group", "ADBE Vector Shape - Ellipse" ]);
    }
}).call(this);
