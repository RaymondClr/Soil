// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/18 11:19:39
...
(function() {
    ...
    eachItems(app.project, function(item, index) {
        log("".concat(index, " ").concat(item.name));
    });
    eachItems(app.project.rootFolder, function(item, index) {
        log("".concat(index, " ").concat(item.name));
    });
    eachItems(app.project.renderQueue, function(renderQueueItem, index) {
        log("".concat(index, " ").concat(renderQueueItem.comp.name));
    });
}).call(this);
