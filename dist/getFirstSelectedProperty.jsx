// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/18 21:12:28
...
(function() {
    ...
    if (isProperty(selectedProperty)) {
        log("".concat(selectedProperty.propertyIndex, " | ").concat(selectedProperty.name, " | ").concat(selectedProperty.matchName));
    }
}).call(this);
