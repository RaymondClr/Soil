// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/21 11:58:27
...
(function() {
    ...
    if (selectedProperty) {
        if (hasKeyframes(selectedProperty)) {
            var firstSelectedKeyIndex = findKeyframeIndex(selectedProperty, function(property, keyIndex) {
                return property.keySelected(keyIndex);
            });
