// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/20 17:27:34
...
(function() {
    ...
    function reverseKeyframeValues(keyframeValues, reverseKeyTime) {
        if (reverseKeyTime === void 0) {
            reverseKeyTime = true;
        }
        var keyTimes = map(keyframeValues, function(keyframe) {
            return keyframe.keyTime;
        });
    ...
    if (selectedProperties) {
        forEach(selectedProperties, function(property) {
            if (hasKeyframes(property)) {
                var keyframes = getKeyframeValues(property);
                var reversedKeys_1 = reverseKeyframeValues(keyframes, false);
                setUndoGroup("Reverse Keyframe", function() {
                    removeKeyframes(property);
                    setKeyframeValues(property, reversedKeys_1);
                });
            }
        });
    }
