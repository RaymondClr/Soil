// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/18 10:33:56
...
(function() {
    ...
    eachFoldersRight(pathDesktop.fsName, function(file, index) {
        log("".concat(index + 1, " ").concat(file.fsName));
    });
}).call(this);
