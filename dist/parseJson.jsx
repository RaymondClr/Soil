// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/21 10:41:46
...
(function() {
    ...
    var config = parseJson('{"version": 2025, "name": "After Effects"}');
    log("".concat(config.name, " ").concat(config.version));
}).call(this);
