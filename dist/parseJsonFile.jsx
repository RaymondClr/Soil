// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/20 22:27:45
...
(function() {
    ...
    var textPath = createPath(pathDesktop.fsName, "Soil.json");
    writeJson(textPath, {
        version: 2025,
        name: "After Effects"
    });
    var data = parseJsonFile(textPath);
    alert("".concat(data.name, " ").concat(data.version));
}).call(this);
