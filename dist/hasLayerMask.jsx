// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/19 10:56:05
...
(function() {
    ...
    if (hasLayerMask(selectedLayer)) {
        var maskProperty = selectedLayer.mask;
        eachPropertiesRight(maskProperty, function(property) {
            property.remove();
        });
    }
}).call(this);
