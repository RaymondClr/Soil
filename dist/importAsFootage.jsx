// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/21 09:49:26
...
(function() {
    ...
    var sequencePath = createPath(pathDesktop.fsName, "Sequence", "image_01.png");
    importAsFootage(sequencePath, false);
    importAsFootage(sequencePath, true);
}).call(this);
