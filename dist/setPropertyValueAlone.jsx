// Raymond Yan (raymondclr@foxmail.com / qq: 1107677019) - 2024/11/20 23:19:06
...
(function() {
    ...
    if (isRasterLayer(selectedLayer)) {
        setPropertyValueAlone(selectedLayer, [ "effect", "ADBE Channel Blur", "ADBE Channel Blur-0004" ], 1);
        setPropertyValueAlone(selectedLayer, [ "effect", "ADBE Channel Blur", "ADBE Channel Blur-0004" ], 2);
    }
}).call(this);
